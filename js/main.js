window.addEventListener("DOMContentLoaded",function(){
    ...
    // var card3590 = document.getElementsByClassName('one'); 
    // var card3990 = document.getElementsByClassName('two');

    // slider.noUiSlider.on('change', (values) => {
    //     if ( 1300 <= values[0] <= 3590  && 1300 <= values[1] <= 3590
    //         && values[0] < 3590 && values[1] < 3590) {
    //         for (var i = 0; i < card3590.length; i++) {
    //             card3590[i].classList.add('off-list-2');
    //         }

    //         for (var k = 0; k < card3590.length; k++) {
    //             card3990[k].style.display = 'none';
    //         }
    //     }else {
    //         for (var i = 0; i < card3590.length; i++) {
    //             card3590[i].classList.remove('off-list-2');
    //         }
    //     if (1300 <= values[0] <= 4001  && 1300 <= values[1] <= 4001
    //         && values[0] > 3590 && values[1] > 3590) {
    //             for (var k = 0; k < card3590.length; k++) {
    //                 card3990[k].style.display = 'block';
    //             }
    //         }
    //     }
    // })
